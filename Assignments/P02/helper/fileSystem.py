...
#This file will have all command related to FileSystem like cd, mkdir 
...
class FileSystem:
    def __init__(self,conn=None):
        if not conn:
            ...
            self.conn = conn
        #maintain the user session and current directory    
        self.user="root"
        self.user_id=1
    ...
    def base_url(self):
        ''' This method will return current base url like /home/leo
    ...
    def current_usr(self):
        ''' This method will return current user like root

            - **Params:**
            - kwargs: None
            
            - **Returns:**
            - (String) : current ownr, id
        '''
    ...
    def history(self, **kwargs):
        """ Get all history of all comands for that logined user
        """
